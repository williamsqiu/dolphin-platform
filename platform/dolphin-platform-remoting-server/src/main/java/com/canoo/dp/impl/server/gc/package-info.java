 ...
 * As defined by {@link com.canoo.platform.remoting.server.RemotingModel} and {@link com.canoo.platform.remoting.DolphinBean} each
 ...
 * How a bean can be created and removed is defined by the {@link com.canoo.platform.remoting.BeanManager}. by using the garbage collection
 * an application developer doesn't need to call {@link com.canoo.platform.remoting.BeanManager#remove(Object)} anymore.
 *
