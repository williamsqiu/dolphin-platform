...
public class ServerCoreComponents {
    ...
    protected ServerCoreComponents(final ServletContext servletContext, final PlatformConfiguration configuration, final PlatformThreadFactory threadFactory, ClasspathScanner classpathScanner, ManagedBeanFactory managedBeanFactory) {
