...
public class KeycloakConfiguration implements Serializable {
    ...
    public KeycloakConfiguration(final PlatformConfiguration platformConfiguration) {
        ...
        this.realmName = platformConfiguration.getProperty(SECURITY_REALM_PROPERTY_NAME);
        this.applicationName = platformConfiguration.getProperty(SECURITY_APPLICATION_PROPERTY_NAME);
        this.authEndpoint = platformConfiguration.getProperty(SECURITY_SERVER_URL_PROPERTY_NAME);
        this.secureEndpoints.addAll(platformConfiguration.getListProperty(SECURE_ENDPOINTS_PROPERTY_NAME));
        this.securityActive = platformConfiguration.getBooleanProperty(SECURITY_ACTIVE_PROPERTY_NAME);
    }
