...
public class StrictClientSessionSupportingURLConnectionResponseHandler implements HttpURLConnectionHandler {

    private final URL url;

    public StrictClientSessionSupportingURLConnectionResponseHandler(final URL url) {
